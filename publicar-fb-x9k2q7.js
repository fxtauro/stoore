...
// Sem OAuth, sem cabeçalhos especiais — a segurança vem apenas de este caminho
// (publicar-fb-x9k2q7) ser um nome aleatório que só tu conheces.
    ...
    if (method === "initialize") {
      res.status(200).json(
        jsonRpcResult(id, {
          ...
          capabilities: { tools: {} },
          serverInfo: { name: "fb-page-publisher", version: "1.2.0" }
        })
      );
      return;
    }
